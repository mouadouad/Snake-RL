...
agent = dqn_agent.DqnAgent(
    ...
    q_network=q_net,
    optimizer=optimizer,
    td_errors_loss_fn=common.element_wise_squared_loss, #common.element_wise_squared_loss,  # common.element_wise_huber_loss
...
with open(os.path.join('snake4_tf_agents.tflite'), 'wb') as f:
